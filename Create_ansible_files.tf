...
# Users
users:
  - { name: "${local.user1_name}", password: "${random_password.users_vms.result}", sshkey: "${local.user1_sshkey}" }   
  - { name: "${local.user2_name}", password: "${random_password.users_vms.result}", sshkey: "${local.user2_sshkey}" }
